...
{
    TYPE_DREAM, TYPE_DREAM, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DREAM, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DREAM, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DREAM, TYPE_DARK2, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DREAM, TYPE_REASON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DREAM, TYPE_HEART, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_BEAST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_REASON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GHOST, TYPE_HEART, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_BEAST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FLYING, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_NATIVE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BEAST, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_BEAST, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BEAST, TYPE_NATIVE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_MIASMA, TYPE_NATIVE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_MIASMA, TYPE_REASON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_STEEL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_DARK2, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_STEEL, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_STEEL, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK2, TYPE_DREAM, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK2, TYPE_DARK2, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DARK2, TYPE_REASON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK2, TYPE_HEART, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_EARTH, TYPE_FLYING, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_EARTH, TYPE_WIND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_EARTH, TYPE_NATIVE, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FIRE, TYPE_NATIVE, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_WATER, TYPE_NATIVE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WATER, TYPE_FAITH, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_EARTH, TYPE_MUL_NO_EFFECT,
    TYPE_WIND, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_NATIVE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_FAITH, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATIVE, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATIVE, TYPE_MIASMA, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATIVE, TYPE_EARTH, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATIVE, TYPE_FIRE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NATIVE, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NATIVE, TYPE_NATIVE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ICE, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ICE, TYPE_WATER, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ICE, TYPE_NATIVE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ICE, TYPE_ICE, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAITH, TYPE_MIASMA, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAITH, TYPE_DARK2, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FAITH, TYPE_REASON, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FAITH, TYPE_HEART, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_REASON, TYPE_DREAM, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_REASON, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_REASON, TYPE_MIASMA, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_REASON, TYPE_FAITH, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_REASON, TYPE_HEART, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HEART, TYPE_DREAM, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HEART, TYPE_MIASMA, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_HEART, TYPE_DARK2, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_ILLUSION, TYPE_DREAM, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ILLUSION, TYPE_DARK2, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_REASON, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_DARK2, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_ILLUSION, TYPE_GHOST, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_ILLUSION, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_DARK2, TYPE_MUL_NO_EFFECT,
    TYPE_MYSTERY, TYPE_MYSTERY, TYPE_MUL_NOT_EFFECTIVE,
...
{
    [TYPE_ILLUSION] = _("ILLUSI"),
    [TYPE_DARK2] = _("DARK"),
    [TYPE_FLYING] = _("FLYING"),
    [TYPE_MIASMA] = _("MIASMA"),
    [TYPE_EARTH] = _("EARTH"),
    [TYPE_BEAST] = _("BEAST"),
    [TYPE_DREAM] = _("DREAM"),
    [TYPE_GHOST] = _("GHOST"),
    ...
    [TYPE_FIRE] = _("FIRE"),
    [TYPE_WATER] = _("WATER"),
    [TYPE_NATIVE] = _("NATIVE"),
    [TYPE_WIND] = _("WIND"),
    [TYPE_REASON] = _("REASON"),
    [TYPE_ICE] = _("ICE"),
    [TYPE_FAITH] = _("FAITH"),
    [TYPE_HEART] = _("HEART"),
};
...
static void HandleAction_UseMove(void)
{
     ...
     && gBattleMons[gSideTimers[side].followmeTarget].hp != 0)
    {
        gBattlerTarget = gSideTimers[side].followmeTarget;
          ...
          && gBattleMoves[gCurrentMove].type == TYPE_WIND)
    {
