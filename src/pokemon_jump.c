...
} sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_CHIBI_LILY_WHITE,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_LILY_BLACK,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_MOMIJI,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_SHIZUHA,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_SHIZUHA,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_NAZRIN,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_NAZRIN,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_CIRNO,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_RUMIA,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_SHANGHAI,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_HOURAI,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_YUKARI,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_SUIKA,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_MYSTIA, .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_KEINE,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_IKU,      .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_CHEN,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_YORIHIME,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_KAGUYA,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_MOKOU,  .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_HATATE,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_TENSHI, .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_KOMACHI,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_LUNASA,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_LYRICA,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_LAYLA,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_KEDAMA,      .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_NUE,      .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_MARISA,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_REIMU,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_AKYUU,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_OONAMAZU,  .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_CHIBI_ORANGE,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_KAZAMI,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_SARA,      .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_CHIBI_LOUISE,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_LOUISE,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_ALICE_98,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_HAKUREI,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_KIRISAME,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_KOTOHIME,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_RIKA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_MUGETSU,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_CHIBI_MAI,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_NITORI,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_REISEN,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SUPPORT_SAKUYA,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_SPEED_RUMIA,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_MYSTIA,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_TECHNICAL_AYA,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEFENSE_PARSEE,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ATTACK_KOISHI,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_TECHNICAL_BYAKUREN,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_TECHNICAL_ICHIRIN,   .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_KANAKO,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEFENSE_KANAKO,      .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_ATTACK_UTSUHO,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_SPEED_KOMACHI,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_SUPPORT_EIRIN,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_ALICE,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_TECHNICAL_ALICE,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_REIMU,  .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_TECHNICAL_CIRNO,  .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_YUYUKO,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ATTACK_YUYUKO,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_SUPPORT_LUNASA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SUPPORT_LYRICA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SUPPORT_RAN,      .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_HINA,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_TECHNICAL_YAMAME,      .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_TECHNICAL_SATORI,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_SPEED_KOGASA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_SHOU,  .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SPEED_RIN,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEFENSE_IKU,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ATTACK_SUIKA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_DEFENSE_WRIGGLE,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_SPEED_MEILING,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_PATCHOULI,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ATTACK_PATCHOULI,       .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEFENSE_LETTY,   .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_SANAE,  .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_ATTACK_NUE,     .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_TECHNICAL_NUE,      .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_DEFENSE_MURASA,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_ATTACK_MURASA,   .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_YUUGI,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_YUUGI,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_FLANDRE,      .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SUPPORT_KOAKUMA,    .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SUPPORT_LILY_WHITE,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_DEFENSE_TEWI,   .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_ATTACK_EIKI,     .jumpType = JUMP_TYPE_SLOW },
    { .species = SPECIES_SPEED_MEDICINE,    .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_ANGEL_VIVIT,     .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_MISSING_POWER_SUIKA,    .jumpType = JUMP_TYPE_NORMAL },
    { .species = SPECIES_RINNOSUKE,   .jumpType = JUMP_TYPE_FAST },
    { .species = SPECIES_ADVENT_LETTY,      .jumpType = JUMP_TYPE_FAST },
};
