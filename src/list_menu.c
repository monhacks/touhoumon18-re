...
{   // { width, height, offset }
    ...
    [TYPE_DARK2 + 1] = { 32, 12, 0x64 },
    [TYPE_FLYING + 1]   = { 32, 12, 0x60 },
    [TYPE_MIASMA + 1]   = { 32, 12, 0x80 },
    [TYPE_EARTH + 1]   = { 32, 12, 0x48 },
    [TYPE_BEAST + 1]     = { 32, 12, 0x44 },
    [TYPE_DREAM + 1]      = { 32, 12, 0x6C },
    [TYPE_GHOST + 1]    = { 32, 12, 0x68 },
    [TYPE_STEEL + 1]    = { 32, 12, 0x88 },
    [TYPE_MYSTERY + 1]  = { 32, 12, 0xA4 },
    [TYPE_FIRE + 1]     = { 32, 12, 0x24 },
    [TYPE_WATER + 1]    = { 32, 12, 0x28 },
    [TYPE_NATIVE + 1]    = { 32, 12, 0x2C },
    [TYPE_WIND + 1] = { 32, 12, 0x40 },
    [TYPE_REASON + 1]  = { 32, 12, 0x84 },
    [TYPE_ICE + 1]      = { 32, 12, 0x4C },
    [TYPE_FAITH + 1]   = { 32, 12, 0xA0 },
    [TYPE_HEART + 1]     = { 32, 12, 0x8C },
