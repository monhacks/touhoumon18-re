const struct BattleTowerPokemonTemplate gBattleTowerLevel100Mons[] =
{
	...
	{
		.species = SPECIES_DEFENSE_REMILIA,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x05,
		.moves = {
			MOVE_SURF,
	...
	{
		.species = SPECIES_DEFENSE_MURASA,
		.heldItem = BATTLE_TOWER_ITEM_BRIGHT_POWDER,
		.teamFlags = 0x09,
		.moves = {
			MOVE_SIGNAL_BEAM,
	...
	{
		.species = SPECIES_ATTACK_SUNNY_MILK,
		.heldItem = BATTLE_TOWER_ITEM_SITRUS_BERRY,
		.teamFlags = 0x43,
		.moves = {
			MOVE_PSYCHIC,
